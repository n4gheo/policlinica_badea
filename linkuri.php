    ...
    <?php include('navhead.php'); ?>
        ...
        <div class="container">
            <div class="row-fluid">
                ...
                <div class="span9">
                    <div class="hero-unit-3">
                        <div class="alert alert-success"><i class="icon-external-link"></i>&nbsp;<strong>Link-uri utile</strong></div>
                            <div class="hero-unit-2">
								<ul>
								<li><a href=http://www.ms.ro/>Ministerul Sanatatii</a></li>
								<li><a href=http://www.cnas.ro/>Casa Nationala de Asigurari de Sanatate</a></li>
								<li><a href=http://www.cmr.ro/>Colegiul Medicilor din Romania</a></li>
								<li><a href=http://www.cmb.ro/>Colegiul Medicilor din Bucuresti</a></li>
								<li><a href=http://www.insp.gov.ro/>Institutul National de Sanatate Publica Bucuresti</a></li>
								<li><a href=http://www.anm.ro/anmdm/>Agentia Nationala a Medicamentului si a Dispozitivelor Medicale</a></li>
								</ul>
								<br>
								<ul><h4><font color="blue">Internetul medical international</font></h4>
									<li><a href=http://www.who.int/en/>Organizatia mondiala a Sanatatii</a></li>
									<li><a href=http://www.emea.europa.eu/ema/>European Medicines Agency</a></li>
								</ul>
                            </div>
                    </div>
